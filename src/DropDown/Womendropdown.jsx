...
const WomendropDown = () => {
    const { womenDropDown, womenMouseEnter, womenMouseLeave } = useContext(DropDownContext)
    return(
        <>
        <style>
            {`
        ...
        <div style={{            
            ...
            <div style={{lineHeight:"25px", width:"25%"}}>
                <Link style={{textDecoration:"none", color:"rgb(251,86,193)"}}>
            ...
            <div style={{lineHeight:"25px", width:"25%"}}>
                ...
                <Link style={{textDecoration:"none", color:"rgb(251,86,193)", marginBottom:"2%"}}>
                    <h5 style={{marginBottom:"4%"}}>
                        Gadgets
                    </h5>
                </Link>
